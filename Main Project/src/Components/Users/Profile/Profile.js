...
export class Profile extends Component {
 ...
 <div className="container py-5 container-short">
                    <div className="row profile position-fixed">
                        <div className="col-md-6 col-xs-12 order-2 order-lg-1 ">
                            <h2 className="text-black font font-weight-normal mb-1">{profile.username}</h2><br/>
                        ...
                        <div className="col-md-6 col-xs-12 order-1 order-lg-2">
                            <img className="img-fluid w-75 rounded-circle mb-3"
 ...
 <div className="container container-short">
                    <h2 className="font font-weight-normal text-black text-uppercase">Posts</h2>
                    <hr />
